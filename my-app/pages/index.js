      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>
            Welcome to Crypto Devs ICO by BGR DRSN!
          </h1>
          <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="./nft-logo-13072.svg" />
        </div>
      </div>

      <footer className={styles.footer}>Developing by Bugra Dursun</footer>
    </div>
  );
}
